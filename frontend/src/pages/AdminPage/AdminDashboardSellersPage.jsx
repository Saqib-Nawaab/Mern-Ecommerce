...
import AdminDashboardSellers from "../../components/Admin/Layout/AdminDashboardSellers.jsx";
import AdminHeader from "../../components/Admin/Header/AdminHeader.jsx";

function AdminDashboardSellersPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex pt-16">
        ...
        <div className={`fixed top-16 left-0 h-[calc(100vh-64px)] z-30 transition-all duration-300 ${sidebarCollapsed ? 'w-20' : 'w-64'}`}>
          <AdminSidebar active={3} onToggle={handleSidebarToggle} />
        </div>
          ...
          <div className="p-4 md:p-6">
            <div className="max-w-full mx-auto">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600 mt-1">Manage and monitor all seller accounts</p>
              </div>
